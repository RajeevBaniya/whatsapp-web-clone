...
const ChatWindow = ({ selectedContact, messages, onSendMessage, onDeleteMessage, onBackToChats, isMobile = false }) => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full overscroll-contain">
      ...
      {/* Messages Area */}
      <div 
        className="flex-1 overflow-y-auto px-2 sm:px-4 lg:px-6 py-1 lg:py-4 min-h-0 will-change-scroll w-full"
        style={{
      ...
      <div className="bg-[#f0f2f5] px-4 py-3 border-t border-[#e9edef] flex-shrink-0 sticky bottom-0">
